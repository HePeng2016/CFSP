...
extern int
tre_regcomp(regex_t *preg, const char *regex, void * buf,int cflags);
...
extern int
tre_regwcomp(regex_t *preg, const wchar_t *regex,void * buf,int cflags);
...
extern int
tre_regncomp(regex_t *preg, const char *regex, size_t len,void * buf,int cflags);
...
#ifdef TRE_WCHAR
extern int
tre_regwncomp(regex_t *preg, const wchar_t *regex, size_t len,void * buff,int cflags);
