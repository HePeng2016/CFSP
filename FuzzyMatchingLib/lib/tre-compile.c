...
int
tre_compile(regex_t *preg, const tre_char_t *regex, size_t n,void * buff,int cflags)
{
  tre_stack_t *stack;
...
#define TRE_OPTIMIZE_FIRST_CHAR 1
 ...
 {
    char * offset =(char *)buff;

     tnfa->Cost = (float*)offset;
     offset = offset+ sizeof(float)*tnfa->num_states;
     tnfa->reachTraceArray = (reachTrace**)offset;
     offset = offset + sizeof(reachTrace*)*MAXSIZE;
     tnfa->alloc  =(reachTrace*)offset;
